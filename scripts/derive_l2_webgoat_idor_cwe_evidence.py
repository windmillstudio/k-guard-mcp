...
SCHEMA = "k_guard_l2_webgoat_idor_cwe_evidence.v1"
APP_ID = "webgoat"
...
TEST_PATH = "src/it/java/org/owasp/webgoat/integration/IDORIntegrationTest.java"
TEST_LINE = 28
TEST_CONTENT_SHA256 = "bcf5db68da5b1574a4710a2cb087a4907ece95e4688310ef7213c957d2ddf6a9"
TEST_BYTE_COUNT = 3117
IMPLEMENTATION_PATH = "src/main/java/org/owasp/webgoat/lessons/idor/IDORViewOtherProfile.java"
IMPLEMENTATION_CONTENT_SHA256 = "305cb5c0fc8d63a0b8bb4f48f4ebc6982ee332bc11c7f1dcc0ad248a3f6ac3e6"
IMPLEMENTATION_BYTE_COUNT = 2605
...
CWE_ID = "CWE-639"
CWE_REFERENCE = "https://cwe.mitre.org/data/definitions/639.html"
SHA256_LENGTH = 64

TEST_ANCHORS = {
    "idor_lesson_selected": b'startLesson("IDOR");',
    "other_profile_read": b'.get(webGoatUrlConfig.url("IDOR/profile/2342388"))',
    "role_attribute_requested": b'params.put("attributes", "userId,role");',
    "other_profile_role_mutation": b'"{\\"role\\":\\"1\\"',
}
IMPLEMENTATION_ANCHORS = {
    "user_controlled_profile_key": b'path = "/IDOR/profile/{userId}"',
    "profile_key_path_variable": b'@PathVariable("userId") String userId',
    "cross_user_key_condition": b'!userId.equals(authUserId)',
    "cross_user_profile_disclosure": b'requestedProfile.profileToMap().toString()',
    "missing_horizontal_authorization_comment": b'horizontal access control check',
}
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Derive source-bound WebGoat IDOR CWE evidence")

...
SCHEMA = "k_guard_l2_webgoat_idor_execution_evidence.v1"
APP_ID = "webgoat"
...
POSITIVE_RESULT_SHA256 = "148c53f8f020ff6213746b781b2f0ee3f842e0f10cef43f51cb392155a44c655"
NEGATIVE_RESULT_SHA256 = "e07e779759f7c27da53419d8a78b852c26730cd7609c45ef682dca7cec102c69"
PROCESS_ARGV = (
    "./mvnw",
    "-o",
    "-B",
    ...
    "-Dit.test=org.owasp.webgoat.integration.IDORIntegrationTest",
    "verify",
)
...
def _load_replay_contract() -> tuple[Any, str]:
    ...
    name = "k_guard_l2_webgoat_idor_execution_evidence_replay"
...
def _source_selector() -> dict[str, Any]:
    ...
    scenario_id = "webgoat:upstream-test-org-owasp-webgoat-integration-idorintegrationtest-testidorlesson:" + identity[:16]
...
def _validate_source_receipt(receipt: dict[str, Any], raw: bytes) -> None:
    ...
    } != {"sha256": SOURCE_CONTENT_SHA256, "byte_count": 3117}:
    ...
    *,
    ...
    for run in runs:
        ...
        if (
            ...
            or normalized.get("test_class") != "org.owasp.webgoat.integration.IDORIntegrationTest"
...
def validate_execution_evidence(payload: dict[str, Any]) -> None:
    ...
    if (
        ...
        or not isinstance(pair.get("negative_control_patch_id"), str)
        or not pair["negative_control_patch_id"]
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Derive raw-free WebGoat IDOR process evidence without admitting registry or release status."
    )

...
SCRIPT = ROOT / "scripts" / "derive_l2_webgoat_idor_state_reset_evidence.py"
SPEC = importlib.util.spec_from_file_location("k_guard_l2_state_reset_evidence_test", SCRIPT)

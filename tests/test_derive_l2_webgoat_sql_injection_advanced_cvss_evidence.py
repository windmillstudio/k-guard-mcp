...
SCRIPT = ROOT / "scripts" / "derive_l2_webgoat_sql_injection_advanced_cvss_evidence.py"
SPEC = importlib.util.spec_from_file_location(
    "k_guard_l2_webgoat_sql_injection_advanced_cvss_evidence_test", SCRIPT
)
...
def _selector() -> dict:
    return {
        ...
        "scenario_id": (
            ...
            "sqlinjectionadvancedintegrationtest-runtests:deadbeefdeadbeef"
        ),
        "raw_returned": False,
    }
